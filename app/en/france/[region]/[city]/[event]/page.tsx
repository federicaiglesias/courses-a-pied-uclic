...
export const generateMetadata = async ({ params }: Props) => {
  ...
  return {
    title: eventData?.title || "Race Details",
    description: `Information about the ${
      eventData?.title || "upcoming"
    } race.`,
  };
};
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 text-white py-20 px-6">
        ...
        <div className="relative max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
            Get ready for an exceptional race in a stunning setting.
          </p>
        </div>
      </section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-gray-50 rounded-xl p-6">
                    ...
                    <p className="text-gray-700 text-lg font-medium">
                      {eventData.distance_km} kilometers
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 border border-green-200">
                    ...
                    <p className="text-green-700 mb-4">
                      Registration is currently open for this race.
                    </p>
                    <a
      ...
      <section className="py-20 px-6 bg-gradient-to-r from-blue-600 to-indigo-700">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join hundreds of runners for this exceptional race in{" "}
            {eventData.city_slug}.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              rel="noopener noreferrer"
            >
              <span>Register for the race</span>
              <svg
                className="w-5 h-5 ml-2"
                fill="none"
                stroke="currentColor"

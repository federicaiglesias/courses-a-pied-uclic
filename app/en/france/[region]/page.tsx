...
export async function generateMetadata({
  ...
  return {
    title: `Running races in ${region}`,
    description: `Find all the running races organized in ${region}`,
  };
}
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 text-white py-20 px-6">
        ...
        <div className="relative max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl max-w-3xl mx-auto mb-8 text-blue-100 leading-relaxed">
            Discover the best running races held in the {region} region.
            <span className="block mt-2 text-lg text-blue-200">
              Explore the cities and find your next race.
            </span>
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Cities in the {region} region
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
              Explore the cities in this region and discover all available
              running races.
            </p>
          </div>
      ...
      {events && events.length > 0 ? (
        <section className="py-16 px-6 bg-gradient-to-r from-gray-50 to-blue-50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
                Running races in {region}
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                Discover our selection of the best running races held in the{" "}
                {region} region.
              </p>
            </div>
        ...
        <section className="py-20 px-6 bg-gradient-to-r from-gray-50 to-blue-50">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">
              There are currently no running events scheduled in the {region}{" "}
              region.
            </p>
      ...
      <section className="py-20 px-6 bg-gradient-to-r from-blue-600 to-indigo-700">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-white mb-6">
            Ready to run in {region}?
          </h2>
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join thousands of runners taking part in the best races in this
            region.
          </p>
